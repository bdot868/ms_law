    ...
    <footer class="footer grey-bg">
        ...
        <div class="container">
	        ...
	        <div class="powered-by">
	            <!-- <a class="" href="https://themeisle.com/themes/parallax-one/" target="_blank" rel="nofollow">Parallax One </a>  -->
              <?php esc_html_e('Website crafted by','parallax-one'); ?> <a class="" href="http://brandoncarter.net" target="_blank" rel="nofollow"><?php esc_html_e('brandoncarter.net','parallax-one'); ?></a>
	        </div>
